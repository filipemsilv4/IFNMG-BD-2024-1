    ...
    try {
      const query = `
        ...
        FROM 
          ...
          LEFT JOIN HUMANO H ON 1=1  -- Joining with all humans, we'll filter later
        ...
        WHERE
          (CI.ID_CIENTISTA IS NOT NULL OR MI.ID_MILITAR IS NOT NULL OR ME.ID_MINERADOR IS NOT NULL)
        ORDER BY 
